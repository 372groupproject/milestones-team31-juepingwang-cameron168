...
Milestone3:
    ...
    2. small program : Given a two dimensional grade list and the list type is string. In each row, the first 4 data                
       demonstrates the midterm grades and the last grade represents final grade. This programming will convert string list        
       to float list. Then, it will drop the lowest midterm grade. 
